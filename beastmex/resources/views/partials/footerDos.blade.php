        ...
        <div class="container text-left text-md-left"> <!-- Aquí justificamos el contenido de cada div en el footer -->
            <div class="row text-left text-md-left">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 font-weight-bold text-primary"> Nombre de la empresa </h5>
                    <p>Beastmex, Inc. es la mejor importadora de México.​ 
                        Opera desde los puertos más importantes del país 
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3 text-left">
                    <h5 class="text-uppercase mb-4 font-weight-bold text-primary">Links útiles</h5>
                        <p>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3 text-left">
                    <h5 class="text-uppercase mb-4 font-weight-bold text-primary">Contacto</h5>
                        ...
                        <p>
                        <i class="fas fa-envelope mr-3"></i>  info.beastmex@gmail.com
                        </p>
                        <p>
                ...
                <div class="col-md-6 col-lg-5">
                    <p> Copyright © 2023 All rights reserved by: 
                        <a href="" style="text-decoration:none;">
                            <strong class="text-primary"> Importadora Beastmex </strong>
                        </a>
                    </p>
                </div>
