    ...
    <div class="col-md-3 ">
      ...
      <div class="botonSuperior"style="padding-left:100px" >
        <form method="get" action="{{ route('apodoUsuarios') }}">
          <button class="btn btn-primary" type="submit" style="width: 200px;"><i class="bi bi-people-fill"></i> Consultar Usuarios</button>
        </form>
      </div>
    </div>
    ...
    <div class="col-md-3 ">
      ...
      <div class="botonSuperior" style="padding-left:10px" >
        <form method="get" action="{{ route('apodoReporte') }}">
          <button class="btn btn-primary" type="submit" style="width: 200px;"><i class="bi bi-bar-chart-line-fill"></i> Consultar Reportes</button>
        </form>
      </div>
    </div>
  </div>
